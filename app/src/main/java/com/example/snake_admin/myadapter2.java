...
public class myadapter2 extends FirebaseRecyclerAdapter<Snake,myadapter2.Myviewholder> {
    public myadapter2(@NonNull FirebaseRecyclerOptions<Snake> options) {
        super(options);
    }
    ...
    protected void onBindViewHolder(@NonNull Myviewholder holder, int position, @NonNull Snake model) {
        ...
        holder.rescuebytxt.setText("Released By: " + model.getName());
        ...
        holder.downbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                StorageReference storageRef = storage.getReference().child("release/"+model.getRandomid());
                            ...
                            item.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                ...
                                public void onSuccess(Uri uri) {
                                    ...
                                    if(!downloadedFiles.contains(fileName)){
                                        ...
                                        request.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, "Snake Release");
                                        DownloadManager manager = (DownloadManager) holder.img.getContext().getSystemService(Context.DOWNLOAD_SERVICE);
                                        manager.enqueue(request);
                                        Toast.makeText(holder.img.getContext(), "Downloading Release...", Toast.LENGTH_SHORT).show();
